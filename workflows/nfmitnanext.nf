...
include { CHOPPER } from '../modules/nf-core/chopper/main'include { MINIMAP2_ALIGN } from '../modules/nf-core/minimap2/align/main'
...
workflow NFMITNANEXT {
    ...
    //         name: 'nf_core_'  +  'nfmitnanext_software_'  + 'mqc_'  + 'versions.yml',
    //         sort: true,
    //         newLine: true
    ...
    // ch_samplesheet.view(i -> 'out inner $i')
